...
########
    ...
    def forward(self, left, right):
        ...
        # Original: cost = F.upsample(cost, [self.maxdisp,left.size()[2],left.size()[3]], mode='trilinear')
        cost = F.interpolate(cost, size=[self.maxdisp,left.size()[2],left.size()[3]], mode='trilinear', align_corners=False)
